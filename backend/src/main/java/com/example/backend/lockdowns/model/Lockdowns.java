package com.example.backend.lockdowns.model;

import org.springframework.data.annotation.Id;
import org.springframework.data.mongodb.core.mapping.Document;

@Document(collection = "lockdowns")
public class Lockdowns {
    ...
    public Lockdowns(String name, String email, String cellNumber, String dateOfDiagnostic, String dateOfLockdown, String placeOfCovid, String nameOfVaccine, String numberOfPeople, String symptoms) {
        this.name = name;
        this.email = email;
